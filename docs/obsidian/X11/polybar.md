...
# wm
## i3
- [折角なのでalterlinux-i3-manager(Polybar)をいじって時刻表示から日時表示に、そしてfcitxのキーボード言語(InputMethod)を表示させる](https://arimasou16.com/blog/2021/09/04/00415/)

## openbox
- [desktop/config-openbox at master · felipefacundes/desktop · GitHub](https://github.com/felipefacundes/desktop/blob/master/polybar/config-openbox)
